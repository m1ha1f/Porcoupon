		...
		*/
		function _caption(index){
			...
			if(contents){
				...
				contents += '<div class="js-overlay-html">';
				
				contents += "<a class='close_button' onclick='reloadDeal(" + index + ");'><img src='assets/close_btn.png'/></a>";
				
				contents += conts + '</div><div style="clear:both"></div>';
			}
